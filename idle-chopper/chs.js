...
var cnItems = {
    ...
    'after': '',
    'After': '',
    'After you chopped the': '',
    'After you chopped the boss, you can go to the next level, where the trees are harder but give more wood': '',
    'all': '',
    'all other trees while fall': '',
    'also': '',
    'Also': '',
    'Amount of trees that': '',
    'Amount of trees that spawn on start of a new level': '',
    'and': '',
    'applied': '',
    ...
    'buy': '',
    'By': '',
    'By chopping a tree, a': '',
    'By chopping a tree, a percentage of the damage gets also applied to all other trees': '',
    'can': '',
    ...
    'character': '',
    'chop': '',
    'Chop a certain amount of': '',
    'Chop a certain amount of trees to let the boss spawn in the middle of the map': '',
    'Chop Helper': '',
    'Chop Speed': '',
    ...
    'the': '',
    'The': '',
    'The amount of Infinikeys': '',
    'The amount of Infinikeys you have, every tree adds +100% levelprogression per key. Also you can use them for something...': '',
    'The amount of soulseeds': '',
    'The amount of soulseeds you have, Use it to buy special upgrades, like bots': '',
    'The amount of wood you': '',
    'The amount of wood you have, Use it to upgrade your character and skills': '',
    'the map': '',
    'The wood chop speed': '',
